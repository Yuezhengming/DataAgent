...
CREATE TABLE IF NOT EXISTS datasource (
  ...
  type VARCHAR(50) NOT NULL COMMENT '数据源类型：mysql, postgresql, csv, excel',
  ...
  description TEXT COMMENT '描述',
  creator_id BIGINT COMMENT '创建者ID',
  file_path VARCHAR(500) COMMENT '文件路径（用于文件类型数据源）',
  file_type VARCHAR(50) COMMENT '文件类型：csv, excel',
